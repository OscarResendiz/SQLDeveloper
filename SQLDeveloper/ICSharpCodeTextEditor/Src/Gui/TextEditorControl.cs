...
namespace ICSharpCode.TextEditor
{
    ...
    {
        public event DragEventHandler OnArrastrarEnter;
        public event DragEventHandler OnSoltar;
        public event EventHandler OnVScrollBarValueChanged;
        public event EventHandler OnHScrollBarValueChanged;
        ...
        public TextEditorControl()
        {
            ...
            primaryTextArea.OnHScrollBarValueChanged += new EventHandler(HScrollBarValueChanged);
            primaryTextArea.OnVScrollBarValueChanged += new EventHandler(VScrollBarValueChanged);
        ...
        #endregion
        #region Codigo Oscar para propagar el evento de las barras espaciadoras
        void VScrollBarValueChanged(object sender, EventArgs e)
        {
            if (OnVScrollBarValueChanged != null)
                OnVScrollBarValueChanged(VScrollBar, e);
        }

        void HScrollBarValueChanged(object sender, EventArgs e)
        {
            if (OnHScrollBarValueChanged != null)
                OnHScrollBarValueChanged(HScrollBar, e);
        }
        public VScrollBar VScrollBar
        {
            get
            {
                return primaryTextArea.vScrollBar;
            }
        }
        ...
        public HScrollBar HScrollBar
        {
            get
            {
                return primaryTextArea.hScrollBar;
            }
        }
        #endregion
    }
