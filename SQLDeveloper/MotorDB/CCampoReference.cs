...
namespace MotorDB
{
    public class CCampoReference: CObjeto
    {
        public CCampoReference(string columnaMaestra, CTipoDato TipoDatoMaestro, int LongitudMatesto, string columnahija, CTipoDato TipoDatoHijo, int LongitudHijo)
        {
        ...
        public CCampoReference(string columnaMaestra, string columnaHija, CTipoDato TipoDato, int longitud)
        {
            CampoPadre = new CCampoBase();
            CampoPadre.Nombre = columnaMaestra;
