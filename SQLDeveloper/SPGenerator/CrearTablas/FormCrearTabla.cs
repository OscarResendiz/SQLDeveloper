...
namespace SPGenerator.CrearTablas
{
    public partial class FormCrearTabla : Form
    {
        ...
        private void BAgregarCampo_Click(object sender, EventArgs e)
        {
            ...
            foreach (CParametroSP obj2 in Campos)
            {
            ...
            CParametroSP obj = new CParametroSP();
        ...
        {
            cTabla1.Clear();
            foreach (CParametroSP dato in Campos)
            {
                bool nulos = false;
        ...
        private void BEditarCampo_Click(object sender, EventArgs e)
        {
            ...
            CParametroSP obj = Campos[dlg.CampoAEliminar];
