  ...
  //          AddLine(tabs + "declare @" + fk.Nombre + " int");
    //        AddLine(tabs + "select @" + fk.Nombre + " =1");
      //      AddLine(tabs + "while(@" + fk.Nombre + " =1)");
        //    AddLine(tabs + "begin");
            AddLine(tabs + "-- vero si existen registros en la tabla " + fk.TablaHija);
            s = "if exists(select 1 from " + fk.TablaHija + " where ";
            ...
            if (fk.GenerarExcepcion == true)
            {
                ...
                {
                    AddLine(tab2 + "RAISERROR(\'" + fk.Mensage + "\', 16, 1)");
                }
                else
                {
                    AddLine(tab2 + "RAISERROR(\'No se puede eliminar el registro de la tabla " + fk.TablaPadre + " porque la tabla " + fk.TablaHija + " contiene información\', 16, 1)");
                }
                AddLine(tab2 + "return");
