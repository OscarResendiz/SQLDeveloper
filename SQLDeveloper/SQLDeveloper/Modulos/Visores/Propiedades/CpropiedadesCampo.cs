...
namespace SQLDeveloper.Modulos.Visores
{
    class CpropiedadesCampo: CPropiedadesBase
    {
        ...
        public CpropiedadesCampo(MotorDB.CCampoBase obj)
        {
            Campo = new MotorDB.CCampo();
            Campo.AceptaNulo= false;
            Campo.CampoCalculado = false;
            Campo.DefaultName = "";
            Campo.EsDefault = false;
            Campo.Formula = "";
            Campo.Longitud = obj.Longitud;
            Campo.Nombre = obj.Nombre;
            Campo.Tipo = obj.Tipo;
            Campo.TipoDato = obj.TipoDato;
            Identidad = null;
            PK = null;
        }
        [
