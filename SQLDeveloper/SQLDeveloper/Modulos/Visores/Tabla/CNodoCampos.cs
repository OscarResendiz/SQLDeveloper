...
namespace SQLDeveloper.Modulos.Visores.Tabla
{
    public class CNodoCampos: CNodoFolder
    {
        ...
        public CNodoCampos(CTabla tabla, MotorDB.IMotorDB db)
            : base(db)
        {
            Tabla = tabla;
            Text = "Campos";
        ...
        private void MuestraCampos()
        {
            ...
            {
                CNodoCampo nodo = new CNodoCampo(Tabla, obj,motor);
                Nodes.Add(nodo);
            }
        }
        public override CVisorBase GetVisor()
        {
            if (Visor == null)
            {
                Visor = new CVisorCampos(Tabla.Nombre,motor);
        ...
        {
            FormAgregarCampo dlg = new FormAgregarCampo(Tabla.Nombre, motor);
