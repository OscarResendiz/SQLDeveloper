...
namespace SQLDeveloper.Modulos.Visores.Tabla
{
    public class CNodoChecks: CNodoFolder
    {
        ...
        public CNodoChecks(CTabla tabla, MotorDB.IMotorDB db)
            : base(db)
        {
            Tabla = tabla;
            Text = "Reglas (Checks)";
        ...
        private void CargaChecks()
        {
            ...
            {
                CNodoCheck ck = new CNodoCheck(Tabla, obj,motor);
                Nodes.Add(ck);
            }
        }
        public override CVisorBase GetVisor()
        {
            if (Visor == null)
            {
                Visor = new CVisorChecks(Tabla.Nombre,motor);
        ...
        {
            FormNewCheck dlg = new FormNewCheck(Tabla.Nombre, motor);
