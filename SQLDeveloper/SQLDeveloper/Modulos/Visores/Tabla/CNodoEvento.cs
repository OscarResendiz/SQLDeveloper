...
namespace SQLDeveloper.Modulos.Visores.Tabla
{
    public class CNodoEvento: CNodoBase
    {
        ...
        public CNodoEvento(MotorDB.IMotorDB db,CTabla tabla, MotorDB.EnumEventTriger ev, MotorDB.EnumMomentTriger t = MotorDB.EnumMomentTriger.AFTER)
            : base(db)
        {
            Tabla = tabla;
            Disparador = ev;
        ...
        public void AddTrriger(MotorDB.CTrigger obj)
        {
           // Nodes.Clear();
            ...
            {
                CNodoTrigger nodo = new CNodoTrigger(motor);
