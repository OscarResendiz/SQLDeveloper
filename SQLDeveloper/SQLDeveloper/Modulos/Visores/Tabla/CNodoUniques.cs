...
namespace SQLDeveloper.Modulos.Visores.Tabla
{
    public class CNodoUniques: CNodoFolder
    {
        ...
        public CNodoUniques(CTabla tabla, MotorDB.IMotorDB db)
            : base(db)
        {
            Tabla = tabla;
            Text = "Valores Unicos";
        ...
        private void CargaUnicos()
        {
            ...
            {
                CNodoUnq un = new CNodoUnq(Tabla, obj,motor);
                Nodes.Add(un);
            }
        }
        public override CVisorBase GetVisor()
        {
            if (Visor == null)
            {
                Visor = new CVisorUnicos(Tabla.Nombre,motor);
        ...
        {
            FormUniqueProperty dlg = new FormUniqueProperty(Tabla.Nombre, motor);
