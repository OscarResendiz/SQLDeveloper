...
namespace SQLDeveloper.Modulos.Visores.Tabla
{
    public partial class FormEditarColumna : Form
    {
        ...
        public FormEditarColumna(string tabla,MotorDB.IMotorDB db)
        {
            motor = db;
            TableName = tabla;           
            InitializeComponent();
        ...
        private void CargaTabla()
        {
            ...
            foreach(MotorDB.CTipoDato tipo in motor.DameTiposDato())
            {
        ...
        private  bool ValidaDatos()
        {
            ...
            if (td.UsaLongitud== MotorDB.TIPO_LONGITUD.OBLIGATORIO)
            {
        ...
        private void Baceptar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                motor.AlterTable_AlterColumn(TableName, campo, nuevo);
            }
        ...
        private TIPO_LONGITUD  EnableLongitd
        {
            ...
            {
                FTipoLongitud = value;
                if (FTipoLongitud == TIPO_LONGITUD.OBLIGATORIO)
                    TLongitud.Enabled = false;
                else
                    TLongitud.Enabled = true;
