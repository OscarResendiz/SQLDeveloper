...
namespace SQLDeveloper.Modulos.Visores.Tabla
{
    public partial class FormNewIndex : Form
    {
        ...
        public FormNewIndex(string tabla,MotorDB.IMotorDB db)
        {
            motor = db;
            TableName = tabla; //contiene el nombre de la tabla
            InitializeComponent();
        }
        ...
        private void CreaPrimaryKey()
        {
            ...
            pk.Campos = l;
            motor.CreaPrimaryKey(pk,TableName);
        }
